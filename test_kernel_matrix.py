...
model = [{'npatch': 3, 'subsampling': 2, 'sigma': 0.65, 'pooling': 'gaussian'},
        {'npatch': 3, 'subsampling': 5, 'sigma': 0.65, 'pooling': 'gaussian'}]
...
print(ckn_kernel.compute_kernel_matrix(x, model=model, verbose=True, lazy=False))
